...
public class MiniTestApp {
  ...
  public static void main(String[] args) {
    ...
    array.add(2, new StudentIn(99876532,"M�ller","Anton","Fliederweg 2","3000","Bern"));
    array.add(3, new StudentIn(98222634,"Stucki","Daniel","Amselweg 2","3600","Thun"));
    array.add(4, new StudentIn(90588921,"M�ller","Kurt","Waldweg 87","3110","M�nsingen"));
    array.add(5, new StudentIn(89345675,"Moser","K�thy","Hauptstrasse 20","2122","Kehrsatz"));
    array.add(6, new StudentIn(98345632,"Schneider","Anna","M�hleplatz 3","3000","Bern"));
    array.add(7, new StudentIn(94419832,"Briod","Jean","Wasserwerkgasse 22","3000","Bern"));
    array.add(8, new StudentIn(99323462,"Fischer","Hans","Rosenweg 2","3110","M�nsingen"));
